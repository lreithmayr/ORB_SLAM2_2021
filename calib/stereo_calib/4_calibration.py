...
while photo_counter != total_photos:
    ...
    if os.path.isfile(leftName) and os.path.isfile(rightName):
        ...
        try:
            cornersLeft = calibrator._get_corners(imgLeft)
            cornersRight = calibrator._get_corners(imgRight)
            # calibrator._show_corners(imgLeft, cornersLeft)
            # calibrator._show_corners(imgRight, cornersRight)
